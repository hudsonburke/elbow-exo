...
// // Adds constant-PWM 0 -> final-angle system-identification trial mode
...
// const unsigned long PRINT_MS = 10;       // 100 Hz compact DATA logging
// const unsigned long DEBUG_PRINT_MS = 100; // 10 Hz visualizer/debug output
...
// // Press n to start one trial: reset -> wait -> move to final angle -> stop.
// // Tune this PWM for your system.
// int TRIAL_PWM = 255;

// const float TRIAL_FINAL_DEG = 90.0;
...
// // Safety timeout for the one-way 0 -> final-angle trial.
// const unsigned long TRIAL_TIMEOUT_MS = 30000;

// // Change this sign if the automatic trial moves the wrong way.
// const int TRIAL_MOVE_DIR = FWD;
...
// // Exact PWM entry mode.
// // Press v, type a value from 0 to 255, then press Enter.
// bool pwmEntryMode = false;
// char pwmEntryBuffer[4] = {'\0', '\0', '\0', '\0'};
// uint8_t pwmEntryLength = 0;
...
// unsigned long trialReachedFinalMs = 0;
// long trialCountsAtFinal = 0;
...
// void beginPwmEntry();
// void handlePwmEntryChar(char c);
...
//   trialReachedFinalMs = 0;
//   trialCountsAtFinal = 0;
// }
...
//   Serial.print(",final_angle_deg,");
//   Serial.println(TRIAL_FINAL_DEG, 2);

//   Serial.println("New one-way constant-PWM trial started. IMU and encoders reset.");
// }
...
//     // Force one final DATA sample before Python saves the timeout file.
//     lastPrintMs = 0;
//     printData();
...
//   if (trialState == TRIAL_MOVING_UP) {
//     m2.target = TRIAL_FINAL_DEG;
//     driveTrialMotor(TRIAL_MOVE_DIR, TRIAL_PWM);

//     if (theta >= TRIAL_FINAL_DEG - TRIAL_TOL_DEG) {
//       off(m2);
//       m2.lastPwm = 0;
//       m2.lastUNorm = 0.0;
//       m2.lastU = 0.0;

//       trialReachedFinalMs = now - trialMotionStartMs;
//       trialCountsAtFinal = counts(m2);
//       trialState = TRIAL_DONE;

//       // Force the final target sample into the CSV before the completion event.
//       lastPrintMs = 0;
//       printData();

//       Serial.print("EVENT,reached_final,");
//       Serial.print(trialId);
//       Serial.print(",");
//       Serial.print(trialReachedFinalMs);
//       Serial.print(",");
//       Serial.print(theta, 3);
//       Serial.print(",");
//       Serial.println(trialCountsAtFinal);

//       Serial.print("RESULT,");
//       Serial.print(trialId);
//       Serial.print(",time_to_final_s,");
//       Serial.print(trialReachedFinalMs / 1000.0, 4);
//       Serial.print(",final_angle_deg,");
//       Serial.print(theta, 3);
//       Serial.print(",counts_at_final,");
//       Serial.println(trialCountsAtFinal);
//     }
...
// void beginPwmEntry() {
//   if (trialIsRunning()) {
//     Serial.println("Cannot change PWM while a trial is running.");
//     return;
//   }
...
//   Serial.println("Enter trial PWM from 0 to 255, then press Enter:");
// }

// void handlePwmEntryChar(char c) {
//   // Enter accepts the typed value.
//   if (c == '\n' || c == '\r') {
//     if (pwmEntryLength == 0) {
//       Serial.println("PWM entry cancelled. No value was entered.");
//     } else {
//       pwmEntryBuffer[pwmEntryLength] = '\0';
//       int requestedPwm = atoi(pwmEntryBuffer);
//       TRIAL_PWM = constrain(requestedPwm, 0, 255);

//       Serial.print("TRIAL_PWM set to ");
...
//     pwmEntryLength = 0;
//     pwmEntryBuffer[0] = '\0';
//     Serial.println("PWM entry cancelled.");
//     return;
//   }
...
//   // Store at most three digits because the maximum PWM is 255.
//   if (isdigit(c) && pwmEntryLength < 3) {
//     pwmEntryBuffer[pwmEntryLength++] = c;
//     pwmEntryBuffer[pwmEntryLength] = '\0';
//   }
// }
...
//   // Keep the compact DATA record at 100 Hz, but throttle the much
//   // larger visualizer/debug block to 10 Hz so serial output does not
//   // reduce or distort the data sampling rate.
//   if (now - lastDebugPrintMs < DEBUG_PRINT_MS) {
//     return;
//   }
...
//   Serial.println();
//   Serial.println("========== MENU ==========");
//   Serial.println("n    : Start constant PWM 0 -> final-angle trial");
//   Serial.println("v    : Enter an exact TRIAL_PWM value (0 to 255)");
...
//   Serial.println();
//   Serial.println("Sampling: 100 Hz DATA logging, 10 Hz debug output");
//   Serial.println("Serial baud: 230400");
