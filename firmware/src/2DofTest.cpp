...
// // ============================================================
// // Two-IMU elbow flexion + forearm pronation test
// //
// // Hardware arrangement:
// //   Both IMUs use the default Wire bus through a TCA9548A multiplexer.
// //   Upper-arm IMU: TCA channel 0
// //   Forearm IMU:   TCA channel 1
// //
// // Controls:
...
// const uint8_t UPPER_IMU_CHANNEL = 0;
// const uint8_t FOREARM_IMU_CHANNEL = 1;
...
// const Vec3 FLEXION_AXIS      = {0.0f, 1.0f, 0.0f};  // Change if needed
...
//   if (!selectTcaChannel(UPPER_IMU_CHANNEL)) {
//     return false;
//   }
//   imu::Quaternion upperCandidate = bnoUpper.getQuat();

//   if (!selectTcaChannel(FOREARM_IMU_CHANNEL)) {
//     return false;
//   }
...
//   Serial.println();
//   printQuat("qUpperRaw", qUpperRaw);
//   printQuat("qForearmRaw", qForearmRaw);
//   printQuat("qUpperZeroed", qUpperZeroed);
//   printQuat("qForearmZeroed", qForearmZeroed);
//   printQuat("qRelativeRaw", qRelativeRaw);
//   printQuat("qJointZeroed", qJointZeroed);
//   printQuat("qFlexion", qFlexion);
//   printQuat("qPronation", qPronation);
...
//   Serial.println("Configured elbow flexion axis: +Y (change FLEXION_AXIS if needed)");
//   Serial.println();
// }
...
//   Serial.println("Starting BNO055 IMUs through TCA9548A...");
