...
// Both IMUs should be aligned parallel to the side of the body, try to align roughly in the same plane
...
// in the upper-arm/joint coordinate frame. currently z (0,0,1)
// ============================================================
...
// Projects quat onto a specified axis then calculates rotation angle
...
void updateKinematics() {
  ...
  // Pronation does not change the forearm longitudinal direction since it rotates about that axis.
  // Therefore qJointZeroed * longAxis, which is rotating the vector by the quat shows flexion independent of pronation.
  ...
  // Removing flexion leaves the local forearm-axis rotation, front multiplying the conjugate subtracts quat.
