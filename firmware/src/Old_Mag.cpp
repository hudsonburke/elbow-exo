...
//   q1 = normalizeQ(bnoUpper.getQuat());
//   q2 = normalizeQ(bnoForearm.getQuat());

//   qRel = relativeQ(q1, q2);
...
//   // TIMEOUT TEMP COMMENTED OUT, UNCOMMENT IF STATEMENT TO RESTORE
//   // ------------------------------------------------
